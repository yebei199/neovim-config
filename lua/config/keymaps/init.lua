...
map("i", "<C-CR>", "<End><CR>", { desc = "End of Line and Newline" })
map({ "i", "c" }, "<C-S-V>", '<C-r>"', { desc = "Paste from Register" })
map({ "i", "c" }, "<S-Insert>", '<C-r>"', { desc = "Paste from Register" })
map({ "i", "c" }, "<C-BS>", "<C-w>", { desc = "Delete Word Backward" })
map({ "i", "c" }, "<C-Delete>", "<C-Right><C-w>", { desc = "Delete Word Forward" })

-- Add undo break-points
map("i", ",", ",<c-g>u", { desc = "Undo Break" })
map("i", ".", ".<c-g>u", { desc = "Undo Break" })
map("i", ";", ";<c-g>u", { desc = "Undo Break" })
...
-- Motion: line start, line end, file end
